...
Download the library from the [CDN](https://unpkg.com/future-flow@0.0.1-44/dist/future-flow.js) and deploy it to Salesforce as a Static Resource.
...
```html
<script src="https://unpkg.com/future-flow@0.0.1-44/dist/future-flow.js"></script>
```
