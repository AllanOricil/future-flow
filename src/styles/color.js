...
export default class Color {
    ...
    static rgbRegex() {
        return new RegExp('rgb\\([0-9]{1,3},[0-9]{1,3},[0-9]{1,3}\\)|rgba\\([0-9]{1,3},[0-9]{1,3},[0-9]{1,3},(([0]*?\.\d*)|1|0)\\)', 'gi');
    }
    ...
    static hexRegex() {
        return new RegExp('^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$', 'gi');
    }

    static isRGB(color) {
        return removeWhiteSpaces(color).match(Color.rgbRegex()) !== null;
    };

    static isRGBA(color) {
        return removeWhiteSpaces(color).match(Color.rgbaRegex()) !== null;
    };

    static isHEX(color) {
        return removeWhiteSpaces(color).match(Color.hexRegex()) !== null;
    };
    ...
    static string2Color(color) {
        ...
        if (Color.isRGB(color) || Color.isRGBA(color)) {
            let colors = removeWhiteSpaces(color).replace('rgb(', '').replace('rgba(', '').replace(')', '').split(',');
            return {
                red: colors[0],
                green: colors[1],
                blue: colors[2],
            ...
            color = removeWhiteSpaces(color).replace('#', '');
